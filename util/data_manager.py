...
class data_manager(object):
    ...
    def get_triplet_ranked_instance(self,set_label,number,method,dual=True):
        ...
        while image_idx<number:
            ...
            r_random = random.randint(0, len(majority_list) - 1)
            r1_random = random.randint(0, len(majority_list) - 1)
            instance_r = majority_list[r_random]

            while(r1_random ==r_random ):
                r1_random = random.randint(0, len(majority_list) - 1)
            instance_1 =  majority_list[r1_random]
