...
class loader(object):
    ...
    def load_train_set(self):
        images,labels=self.load(self.train_file)
        Shape = images.shape
        self.train_image_list = np.reshape(images,(Shape[3],Shape[2],Shape[0],Shape[1]))
    ...
    def load_test_set(self):
        images,labels=self.load(self.test_file)
        Shape = images.shape
        self.test_image_list=np.reshape(images,(Shape[3],Shape[2],Shape[0],Shape[1]))
    ...
    def load(self,file_path):
        ...
        labels = data['y']
        labels[labels==10]=0
        self.image_size = [images.shape[0],images.shape[1]]
